...
```javascript
incrnanmmape = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmape@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-incr-nanmmape/tags). For example,

```javascript
incrnanmmape = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmape@v0.0.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrnanmmape = require( 'path/to/vendor/umd/stats-incr-nanmmape/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-nanmmape@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-incr-nanmmape.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-incr-nanmmape

[test-image]: https://github.com/stdlib-js/stats-incr-nanmmape/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-incr-nanmmape/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-incr-nanmmape/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-incr-nanmmape?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-incr-nanmmape.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-incr-nanmmape/main
...
[deno-url]: https://github.com/stdlib-js/stats-incr-nanmmape/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-incr-nanmmape/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-nanmmape/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-nanmmape/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-nanmmape/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-nanmmape/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-incr-nanmmape/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-incr-nanmmape/main/LICENSE
